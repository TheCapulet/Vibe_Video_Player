...
print("--- APPLYING V82: MODULAR SYNC & VISIBILITY RECOVERY ---")
...
if __name__ == "__main__":
    dl_assets()
    write_f("app/util/config.py", config_content)
    write_f("app/core/vlc_backend.py", backend_content)
    write_f("app/ui/library.py", library_content)
    write_f("app/ui/main_window.py", ui_logic)
    print("\n--- PHASE 82 MASTER RECOVERY COMPLETE. RUN app/main.py ---")